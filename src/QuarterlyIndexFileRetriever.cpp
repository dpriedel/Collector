...
//--------------------------------------------------------------------------------------
QuarterlyIndexFileRetriever::QuarterlyIndexFileRetriever(const std::string &host, const std::string &port,
...
std::chrono::year_month_day QuarterlyIndexFileRetriever::CheckDate(std::chrono::year_month_day day_in_quarter)
{
    input_date_ = {};
...
fs::path QuarterlyIndexFileRetriever::MakeQuarterlyIndexPathName(std::chrono::year_month_day day_in_quarter)
{
...
fs::path QuarterlyIndexFileRetriever::HierarchicalCopyRemoteIndexFileTo(const fs::path &remote_file_name,
                                                                        ...
                                                                        bool replace_files)
{
    ...
    spdlog::info(catenate("Q: Retrieved remote quarterly index file: ", remote_file_name.string(),
...
fs::path QuarterlyIndexFileRetriever::MakeLocalIndexFilePath(const fs::path &local_prefix,
                                                             const fs::path &remote_quarterly_index_file_name)
{
    ...
    std::string remote_index_name = boost::algorithm::replace_first_copy(remote_quarterly_index_file_name.string(),
...
std::vector<fs::path> QuarterlyIndexFileRetriever::MakeIndexFileNamesForDateRange(
...
std::vector<fs::path> QuarterlyIndexFileRetriever::HierarchicalCopyIndexFilesForDateRangeTo(
...
std::vector<fs::path> QuarterlyIndexFileRetriever::ConcurrentlyHierarchicalCopyIndexFilesForDateRangeTo(
    ...
    bool replace_files)
{
    ...
    spdlog::info(catenate("Q: Downloaded: ", success_counter, " Skipped: ", skipped_files_counter,
